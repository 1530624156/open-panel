...
public class Crypt {
	 ...
	 * @throws Exception
	 */
	public static String encodeSn(String username,String password,String key,Date date) throws Exception {
		if(StringUtils.isBlank(key)){
			key = "EW2sdfkj";
		}
		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
		String time = sdf.format(date);
		String s = "<uid>"+username+"</uid><pwd>"+password+"</pwd><time>"+time+"</time>";
		String sn = Crypt.encode(s, key);
		return sn;
	}
	
	public static void main(String[] args) throws Exception {
		String sn = "59118561728FDC189B368C11856CD0ECC39427333974C31AAFCB6556D1B00B197CD752820F3B9C687F9FD9C5835F55B74771D7C3A4F1BABCE82E9C7D37443177";
		String key = "EW2sdfkj";
		String c = decode(sn, key);
	}
}